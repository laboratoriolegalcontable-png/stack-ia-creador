...
- Otherwise use the findings from the most recent audit this session. If no audit has run yet, tell the user to run `/claude-db:db-audit <target>` first — do not invent findings.
