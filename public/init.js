...
import { renderProjectPanel, renderProjectTracker }   from '/project-tracker.js';
...
import { renderContactCrm }      from '/contact-crm.js';
...
document.getElementById('contactcrm-btn')?.addEventListener('click',     () => { renderContactCrm();     trackUsage('contactcrm'); });
